...
closed_omg = cv.morphologyEx(inverted_img, cv.MORPH_OPEN, kernel)

# Inverts the image back
inverted_back = cv.bitwise_not(closed_omg)
...
print(
    "\nImage " + image_path + " has successfully gone through opening and has been stored here: " + save_path)